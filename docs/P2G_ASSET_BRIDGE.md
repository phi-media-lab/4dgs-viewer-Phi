...
Pixel4DGS inference asset and the Phi Remote Frame Mode Player. It is not a
checkpoint importer and does not require PyTorch, Safetensors, a GPU, or the
Pixel4DGS source tree.
